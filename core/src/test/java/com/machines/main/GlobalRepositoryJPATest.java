...
//In short, @Profile defines a com.machines.main.profile like a Debug com.machines.main.profile and a Production com.machines.main.profile etc...
...
public class GlobalRepositoryJPATest {
	...
	/**
	 * Call the method findAll on each DB com.machines.main.repositories that implement this method. This test is very usefull to detect JPA mapping issues with DB.
	 * 
	...
	public void testFindAll() {
		...
		log.debug("{} com.machines.main.repositories", map.size());
		...
		if (!beansInErrors.isEmpty()) {
			Assert.fail(beansInErrors.size() + " com.machines.main.repositories in errors on " + map.size() + " com.machines.main.repositories: " + String.join(",", beansInErrors));
		}
	}
